...
export default class UsuarioRepository{
    ...
    async cadastrar(usuario){
        const sql = "insert into tb_usuario (usu_nome, usu_email, usu_senha, per_id) values (?, ?, ?, ?)";
        const values = [usuario.usu_nome, usuario.usu_email, usuario.usu_senha, usuario.per_id.per_id];
    ...
    async alterar(usuario){
        const sql = "update tb_usuario set  usu_nome = ?, usu_email = ?, usu_senha = ?, per_id = ? where usu_id = ?";
        const values = [
            usuario.usu_nome,
            usuario.usu_email,
            usuario.usu_senha,
